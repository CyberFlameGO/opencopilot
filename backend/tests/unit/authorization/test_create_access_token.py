...
import src.authorization.create_access_token as use_case
from src.service import error_responses


@patch("src.authorization.create_access_token.settings")
...
@patch("src.authorization.create_access_token.settings")
@patch("src.authorization.create_access_token.time")
